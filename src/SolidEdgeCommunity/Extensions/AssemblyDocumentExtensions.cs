...
public static class AssemblyDocumentExtensions
{
    ...
    /// <returns></returns>
    public static Version GetCreatedVersion(this SolidEdgeAssembly.AssemblyDocument document) => new Version(document.CreatedVersion);
    ...
    /// <param name="document"></param>
    /// <returns></returns>
    public static Version GetLastSavedVersion(this SolidEdgeAssembly.AssemblyDocument document) => new Version(document.LastSavedVersion);
