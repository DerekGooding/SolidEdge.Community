...
public static class PropertySetsExtensions
{
    ...
    /// Adds or modifies a custom property.
    /// </summary>
    public static SolidEdgeFileProperties.Property UpdateCustomProperty(this SolidEdgeFileProperties.PropertySets propertySets, string propertyName, bool propertyValue) => propertySets.InternalUpdateCustomProperty(propertyName, propertyValue);

    /// <summary>
    /// Adds or modifies a custom property.
    /// </summary>
    public static SolidEdgeFileProperties.Property UpdateCustomProperty(this SolidEdgeFileProperties.PropertySets propertySets, string propertyName, DateTime propertyValue) => propertySets.InternalUpdateCustomProperty(propertyName, propertyValue);

    /// <summary>
    /// Adds or modifies a custom property.
    /// </summary>
    public static SolidEdgeFileProperties.Property UpdateCustomProperty(this SolidEdgeFileProperties.PropertySets propertySets, string propertyName, double propertyValue) => propertySets.InternalUpdateCustomProperty(propertyName, propertyValue);

    /// <summary>
    /// Adds or modifies a custom property.
    /// </summary>
    public static SolidEdgeFileProperties.Property UpdateCustomProperty(this SolidEdgeFileProperties.PropertySets propertySets, string propertyName, int propertyValue) => propertySets.InternalUpdateCustomProperty(propertyName, propertyValue);

    /// <summary>
    /// Adds or modifies a custom property.
    /// </summary>
    public static SolidEdgeFileProperties.Property UpdateCustomProperty(this SolidEdgeFileProperties.PropertySets propertySets, string propertyName, string propertyValue) => propertySets.InternalUpdateCustomProperty(propertyName, propertyValue);
}