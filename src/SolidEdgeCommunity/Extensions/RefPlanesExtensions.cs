...
public static class RefPlanesExtensions
{
    ...
    /// </summary>
    public static SolidEdgePart.RefPlane GetTopPlane(this SolidEdgePart.RefPlanes refPlanes) => refPlanes.Item(1);

    /// <summary>
    /// Returns a SolidEdgePart.RefPlane representing the default right plane.
    /// </summary>
    public static SolidEdgePart.RefPlane GetRightPlane(this SolidEdgePart.RefPlanes refPlanes) => refPlanes.Item(2);

    /// <summary>
    /// Returns a SolidEdgePart.RefPlane representing the default front plane.
    /// </summary>
    public static SolidEdgePart.RefPlane GetFrontPlane(this SolidEdgePart.RefPlanes refPlanes) => refPlanes.Item(3);
}